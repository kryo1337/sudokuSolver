...
class Grid:
    ...
    def draw(self, win):
        ...
        button_rect = pygame.Rect(300, 560, 60, 30)
        self.button = button_rect
        pygame.draw.rect(win, (0, 0, 0), button_rect)
        fnt = pygame.font.SysFont("comicsans", 18)
        text = fnt.render("Solve", True, (255, 255, 255))
        win.blit(text, (306, 560))
...
def redraw_window(win, board, time, strikes):
    ...
    fnt = pygame.font.SysFont("comicsans", 26)
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if board.button.collidepoint(pos):
                    board.SolveAll()
